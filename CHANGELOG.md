...
- Sync command autodiscovery: Fixed `cmd_sync` to properly fall back to autodiscovery when no explicit samizdat classes are provided and `samizdatmodules` is empty
