...
- Empty samizdatmodules parameter: Fixed `get_sds()` to treat empty `samizdatmodules` list as "not specified", allowing autodiscovery to run instead of returning empty results
