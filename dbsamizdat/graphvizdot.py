...
from .libgraph import (gen_autorefresh_edges, gen_edges, gen_unmanaged_edges,
                       toposort, unmanaged_refs)
...
def dot(samizdats):
    ...
    """
    samizdats = set(
        filter(lambda s: not getattr(s, "autorefresher", False), samizdats)
    )  # filter out autogenerated functions/triggers — autorefresh relationships will be expressed as edges only
